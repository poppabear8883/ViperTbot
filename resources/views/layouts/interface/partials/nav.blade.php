...
<aside id="left-panel" xmlns:v-on="http://www.w3.org/1999/xhtml">
    ...
    <nav>
        <ul>
            ...
            <li>
                <a href="#"><i class="fa fa-lg fa-fw fa-twitch"></i> <span class="menu-item-parent">Twitch</span></a>
                <ul>
                    <li>
                        <a href="#">
                            Following
            ...
            <li>
                <a href="#"><i class="fa fa-lg fa-fw fa-star"></i> <span class="menu-item-parent">Regulars</span></a>
                <ul>
                    <li>
